# Speaker Recognition System Development
...
The system is built using [PyTorch](https://pytorch.org/tutorials/) and [librosa](https://librosa.org/doc/latest/index.html)

## Disclaimers

The purpose of this project is to build a **minimal working system** using simple Python code, and will NOT make use of advanced library or features that are frequently used in academia and industry.
...
* `TRAIN_DATA_DIR = "/home/dagorislab/Code/github/speaker-recognition/data/LibriSpeech/train-clean-100"`

* `TEST_DATA_DIR = "/home/dagorislab/Code/github/speaker-recognition/data/LibriSpeech/test-clean"`
...
As said earlier, this is NOT a very good system. 8% is a very high EER.
...
I have pretrained a few models, these models are localed under `saved_model/pretrained`.
